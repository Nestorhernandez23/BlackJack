...
public final class PGame extends JPanel {
	...
	public void setBannerTextColor(Color color) {
	 ...
	 */
	public static PGame run(PDeck deck, PHand dealer, PHand player) {
	...
	public PGame(PDeck deck, PHand dealer, PHand player) {
		this.deck = deck;
		this.dealer = dealer;
		this.player = player;
